    ...
    <>
      ...
      <main className="login-wrap theme">
        ...
        <div className="brand-chip">
          {/* use your real logo in /public */}
          <img src="/cross-border-cart-logo.png" alt="Cross Border Cart logo" />
          <span>Cross Border Cart</span>
        </div>

        {/* Two-column layout on desktop */}
        <div className="login-shell">
          {/* Left: marketing / reassurance panel (hidden on small screens) */}
          <aside className="side-panel">
            <p className="side-pill">Ship from UAE to your doorstep</p>
            <h1>Your Cross Border Cart account</h1>
            <p className="side-sub">
              One place to track your shipments, manage your UAE address and see
              what&apos;s in transit at a glance.
            </p>
            ...
            <ul className="side-list">
              <li>
                ...
                <div>
                  <strong>Live shipment overview</strong>
                  <span> Follow parcels from Dubai to your country in real time.</span>
                </div>
              </li>
              <li>
                <span className="dot">●</span>
                <div>
                  ...
                  <span> Decide when to ship, what to combine and how to save.</span>
                </div>
              </li>
              <li>
                <span className="dot">●</span>
                <div>
                  <strong>Built for UAE ➝ Africa lanes</strong>
                  <span> Optimised routes, honest pricing and human support.</span>
                </div>
              </li>
            </ul>
            ...
            <p className="side-foot">
              New here?{" "}
              <Link href="/signup" className="side-link">
